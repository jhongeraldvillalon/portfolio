...
import profilePic from "../assets/jhonGeraldProfile.jpg"
            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Jhon Gerald Villalon</h1>
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <img src={profilePic}  alt="Jhon Gerald Villalon"  />
                    </div>
                </div>
            </div>
        </div>
